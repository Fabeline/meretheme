...
function checkIfAllAreDone() {
    console.log("Checking if all are done", fontAwesomeDone, markdownDone, bootstrapDone, prismDone)
    if (fontAwesomeDone && markdownDone && bootstrapDone && prismDone) {
